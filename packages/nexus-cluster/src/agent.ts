...
export class NodeAgent {
  ...
  startService(): void {
    ...
    // Windows: service commands are often .cmd shims that need a shell. Pass the
    // full command line instead of a separate args array to avoid Node's DEP0190
    // warning (args + shell: true are only concatenated anyway).
