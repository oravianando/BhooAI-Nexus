...
import {
  ...
  type ServiceState, type AdminConfig, type AdminEnv, type EnvEntry, type DatabaseInfo, type GeneratedSchema, type PaymentProviderStatus, type AiStatus, type UserRecord, type RoleDefinition, type PreflightReport, type PreflightCheck,
} from './api.js';
          ...
          <div className="preflight-list">
            {preflight.checks.map((c) => (
              <div key={c.name} className="preflight-row">
                ...
                {c.error && <span className="preflight-error">{c.error}</span>}
              </div>
            ))}
          </div>
        )}
