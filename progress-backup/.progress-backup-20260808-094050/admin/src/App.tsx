            ...
            {searchOpen && search.length > 0 && (
              <div className="admin-search-results">
                {searchResults.length === 0 ? (
                  ...
                  searchResults.map((n) => (
                    <button key={n.id} className={tab === n.id ? 'is-active' : ''} onMouseDown={(e) => { e.preventDefault(); setTab(n.id); setSearch(''); setSearchOpen(false); }}>
